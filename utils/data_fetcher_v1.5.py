# utils/data_fetcher_v1.5.py
"""데이터 조회 및 처리 함수 v1.5 - order_item.due_price 사용 (입금가)"""
...
_query_builder_path = os.path.join(os.path.dirname(__file__), 'query_builder_v1.5.py')
spec = importlib.util.spec_from_file_location("query_builder_v1_5", _query_builder_path)
query_builder_v1_5 = importlib.util.module_from_spec(spec)
sys.modules["query_builder_v1_5"] = query_builder_v1_5
spec.loader.exec_module(query_builder_v1_5)

from query_builder_v1_5 import (  # type: ignore
