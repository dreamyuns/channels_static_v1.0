...
이 문서는 v1.3까지의 변경사항을 GitHub에 안전하게 업로드하는 방법을 안내합니다.
...
- `README.md` (업데이트)
- `docs/GITHUB_UPLOAD_GUIDE_V1.3.md` (새 문서)
- `docs/DEPLOYMENT_GUIDE_V1.3.md` (새 문서)
...
# 또는 특정 파일만 추가
git add app_v1.3.py
git add utils/*v1.3.py
git add README.md
git add docs/GITHUB_UPLOAD_GUIDE_V1.3.md
git add docs/DEPLOYMENT_GUIDE_V1.3.md

# 커밋 메시지 작성
git commit -m "feat: v1.3 업데이트
...
1. `docs/DEPLOYMENT_GUIDE_V1.3.md` 참고
2. 서버에서 `git pull` 실행
3. systemd 서비스 재시작
...
```
feat: v1.3 업데이트 - 확정/취소 객실수 및 취소율 추가
...
1. ✅ GitHub 업로드 완료
2. ✅ 운영서버 배포 (`docs/DEPLOYMENT_GUIDE_V1.3.md` 참고)
3. ✅ 기능 테스트
4. ✅ 문서 업데이트 확인
